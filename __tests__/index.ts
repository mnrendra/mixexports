...
describe('Test all features:', () => {
  it('Should resolve "./tests/dummies/1.expected.js" when given "./tests/dummies/1.resource.js"!', async () => {
  ...
  it('Should resolve "./tests/dummies/2.expected.js" when given "./tests/dummies/2.resource.js"!', async () => {
  ...
  it('Should resolve "./tests/dummies/3.expected.js" when given "./tests/dummies/3.resource.js"!', async () => {
  ...
  it('Should resolve "./tests/dummies/4.expected.js" when given "./tests/dummies/4.resource.js"!', async () => {
  ...
  it('Should resolve "./tests/dummies/5.expected.js" when given "./tests/dummies/5.resource.js"!', async () => {
  ...
  it('Should resolve "./tests/dummies/6.expected.js" when given "./tests/dummies/6.resource.js"!', async () => {
  ...
  it('Should resolve "./tests/dummies/7.expected.js" when given "./tests/dummies/7.resource.js"!', async () => {
  ...
  it('Should resolve "./tests/dummies/8.expected.js" when given "./tests/dummies/8.resource.js"!', async () => {
  ...
  it('Should resolve "./tests/dummies/21.expected.js" when given "./tests/dummies/21.resource.js"!', async () => {
  ...
  it('Should resolve "./tests/dummies/22.expected.js" when given "./tests/dummies/22.resource.js"!', async () => {
  ...
  it('Should resolve "./tests/dummies/23.expected.js" when given "./tests/dummies/23.resource.js"!', async () => {
  ...
  it('Should resolve "./tests/dummies/24.expected.js" when given "./tests/dummies/24.resource.js"!', async () => {
  ...
  it('Should resolve "./tests/dummies/25.expected.js" when given "./tests/dummies/25.resource.js"!', async () => {
  ...
  it('Should resolve "./tests/dummies/1.expected.min.js" when given "./tests/dummies/1.resource.js"!', async () => {
    const resource = read('./tests/dummies/1.resource.js')
  ...
  it('Should resolve "./tests/dummies/2.expected.min.js" when given "./tests/dummies/2.resource.js"!', async () => {
    const resource = read('./tests/dummies/2.resource.js')
    const received = await index(resource, { minify: true })
  ...
  it('Should resolve "./tests/dummies/3.expected.min.js" when given "./tests/dummies/3.resource.js"!', async () => {
    const resource = read('./tests/dummies/3.resource.js')
    const received = await index(resource, { minify: true })
  ...
  it('Should resolve "./tests/dummies/21.expected.min.js" when given "./tests/dummies/21.resource.js"!', async () => {
    const resource = read('./tests/dummies/21.resource.js')
    const received = await index(resource, { minify: true })
  ...
  it('Should resolve "./tests/dummies/22.expected.min.js" when given "./tests/dummies/22.resource.js"!', async () => {
    const resource = read('./tests/dummies/22.resource.js')
    const received = await index(resource, { minify: true })
  ...
  it('Should resolve "./tests/dummies/23.expected.min.js" when given "./tests/dummies/23.resource.js"!', async () => {
    const resource = read('./tests/dummies/23.resource.js')
    const received = await index(resource, { minify: true })
  ...
  it('Should resolve "./tests/dummies/24.expected.min.js" when given "./tests/dummies/24.resource.js"!', async () => {
    const resource = read('./tests/dummies/24.resource.js')
    const received = await index(resource, { minify: true })
  ...
  it('Should resolve "./tests/dummies/25.expected.min.js" when given "./tests/dummies/25.resource.js"!', async () => {
    const resource = read('./tests/dummies/25.resource.js')
    const received = await index(resource, { minify: true })
  ...
  it('Should reject within error when given "./tests/dummies/34.expected.js"!', async () => {
    const resource = read('./tests/dummies/34.resource.js')
    const received = index(resource)
  ...
  it('Should reject within error when given "./tests/dummies/35.expected.js"!', async () => {
    const resource = read('./tests/dummies/35.resource.js')
    const received = index(resource)
    await expect(received).rejects.toThrow(Error('Your code contains a shebang "#!/usr/bin/env node" and exports, so it cannot be processed!'))
  })

  it('Should reject within error when given "./tests/dummies/36.expected.js"!', async () => {
    const resource = read('./tests/dummies/36.resource.js')
    const received = index(resource)
    await expect(received).rejects.toThrow(Error('Your code contains a shebang "#!/usr/bin/env node" and exports, so it cannot be processed!'))
  })

  it('Should resolve "./tests/dummies/37.expected.js" when given "./tests/dummies/37.resource.js"!', async () => {
    const resource = read('./tests/dummies/37.resource.js')
    const received = await index(resource)
